...
@Table(
    ...
    uniqueConstraints = [
        ...
        UniqueConstraint(name = "uq_opening_interval_slot", columnNames = ["opening_id", "interval_start"]),
    ],
    check = [
...
class OpeningIntervalEntity(
    ...
    override fun toString(): String =
        "OpeningIntervalEntity(id=$id, publicId=$publicId, intervalStart=$intervalStart, intervalEnd=$intervalEnd, participantLimit=$participantLimit)"
