...
@Table(
    ...
    uniqueConstraints = [
        ...
        UniqueConstraint(name = "uq_opening_booking_user_interval", columnNames = ["user_id", "interval_id"]),
    ],
    indexes = [
...
class OpeningBookingEntity(
    ...
    override fun toString(): String =
        "OpeningBookingEntity(id=$id, publicId=$publicId, seatCount=$seatCount, status=$status, chargedAt=$chargedAt)"
}
